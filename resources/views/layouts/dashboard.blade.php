...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li class=""><a href="{{ route('activity.index') }}"><i class="zmdi zmdi-home"></i><span>Activities</span></a></li>
...
<aside id="rightsidebar" class="right-sidebar">
    <ul class="nav nav-tabs sm">
        ...
        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#chat"><i class="zmdi zmdi-clipboard"></i></a></li>
    </ul>
